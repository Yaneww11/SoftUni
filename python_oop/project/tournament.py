...
class Tournament:
    ...
    def sell_equipment(self, equipment_type: str, team_name: str):
        ...
        equipment = next((e for e in reversed(self.equipment)
                          if e.__class__.__name__ == equipment_type), None)
    ...
    def play(self, team_name1: str, team_name2: str):
        ...
        winner = team1 if team1_points > team2_points else team2 if team2_points > team1_points \
            else None
        if winner is None:
    ...
    def get_statistics(self):
        ...
        result = [f"Tournament: {self.name}", f"Number of Teams: {len(self.teams)}",
                  "Teams: "]
        [result.append(t.get_statistics()) for t in self.teams]
        return "\n".join(result)
